...
if (isset($_POST['add'])) {
    ...
    $query = mysqli_query($connect, "INSERT INTO `vehicle_categories` (fa_icon, category) VALUES('$fa_icon', '$category')");
}
?>
...
if (isset($_GET['edit-id'])) {
    ...
    if (isset($_POST['edit'])) {
        ...
        $query = mysqli_query($connect, "UPDATE `vehicle_categories` SET fa_icon='$fa_icon', `category`='$category' WHERE id='$id'");
        echo '<meta http-equiv="refresh" content="0; url=vehicle-categories.php">';
