...
if (isset($_POST['add'])) {
    ...
    $query = mysqli_query($connect, "INSERT INTO `hangars` (image, money, gold, respect, min_level, vip, max_vehicles) VALUES ('$image', '$money', '$gold', '$respect', '$minlevel', '$vip', '$max')");
}
?>
...
if (isset($_GET['edit-id'])) {
    ...
    if (isset($_POST['edit'])) {
        ...
        $query = mysqli_query($connect, "UPDATE `hangars` SET `image`='$image', `money`='$money', `gold`='$gold', `respect`='$respect', `min_level`='$minlevel', `vip`='$vip', `max_vehicles`='$max' WHERE id='$id'");
        echo '<meta http-equiv="refresh" content="0; url=hangars.php">';
