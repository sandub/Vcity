...
if (isset($_GET['delete-id'])) {
    ...
    $query = mysqli_query($connect, "DELETE FROM `item_categories` WHERE id='$id'");
}
?>
<div class="content-wrapper">
			...
			<div id="content-container">
				...
				<section class="content-header">
    			  <h1><i class="fas fa-list-ul"></i> Item Categories</h1>
    			  <ol class="breadcrumb">
...
if (isset($_POST['add'])) {
    ...
    $query = mysqli_query($connect, "INSERT INTO `item_categories` (fa_icon, category) VALUES('$fa_icon', '$category')");
}
?>
...
if (isset($_GET['edit-id'])) {
    $id  = (int) $_GET["edit-id"];
    $sql = mysqli_query($connect, "SELECT * FROM `item_categories` WHERE id = '$id'");
    $row = mysqli_fetch_assoc($sql);
    if (empty($id)) {
        echo '<meta http-equiv="refresh" content="0; url=item-categories.php">';
    }
    ...
    if (isset($_POST['edit'])) {
        ...
        $query = mysqli_query($connect, "UPDATE `item_categories` SET fa_icon='$fa_icon', `category`='$category' WHERE id='$id'");
        echo '<meta http-equiv="refresh" content="0; url=item-categories.php">';
...
<table id="dt-basic" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<tbody>
<?php
$query = mysqli_query($connect, "SELECT * FROM `item_categories`");
